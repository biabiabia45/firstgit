...
import myproject.wallet.domain.events.UserCreatedEvent;
import myproject.wallet.domain.events.UserDeletedEvent;
import myproject.wallet.domain.events.UserUpdatedEvent;
import myproject.wallet.domain.repository.UserRepository;
import myproject.wallet.domain.exceptions.UserNotFoundException;
import myproject.wallet.infrastructure.common.db.repositories.persistence.messaging.UserEventProducer;
